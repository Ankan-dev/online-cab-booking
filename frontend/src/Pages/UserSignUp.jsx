    ...
    <div className="flex justify-center items-center min-h-screen bg-[#2c2c36] text-white">
      <div className="flex items-center justify-center w-full h-[100vh] rounded-[10px] bg-cover bg-no-repeat" style={{ backgroundImage: `url(${bg})` }}>
        <div className="w-[500px] bg-[rgba(16,18,27,0.4)] border-[2px] border-[rgba(255,255,255,0.5)] backdrop-blur-[20px] text-white rounded-[10px] p-[30px_40px]">
          <form action="">
            <h1 className="text-[36px] text-center mb-[10px]">Sign Up</h1>
            ...
            <button type="button" onClick={()=>navigate('/captain-signup')} className="w-full h-[45px] bg-[#fdc80c] border-none outline-none mt-[10px] rounded-[40px] shadow-[0_0_10px_rgba(0,0,0,0.1)] cursor-pointer text-[16px] text-black font-semibold hover:bg-white ">
              Register as Captain
            </button>
            <div className="text-center text-[14.5px] my-[20px]">
              <p>
                Already have an account? <Link to='/user-login' className="text-white font-semibold hover:underline">Login</Link>
              </p>
            </div>
          </form>
        </div>
