...
const CaptainHome = () => {
  ...
  return (
    <div className='w-full h-screen relative md:flex'>
      <div className='hidden md:flex flex-col items-center justify-center w-[30rem] h-screen bg-white'>
        <div className='hidden  bg-white absolute md:flex flex-col items-center py-1 transition-all duration-500' style={{ height: containerHeight }}>

          <h1 className='font-bold text-2xl my-3'>Confirm This Ride To Start</h1>
          <div className='w-[90%] h-[4rem] bg-yellow-400 flex items-center justify-around rounded-xl'>
            <img src='https://preview.keenthemes.com/metronic-v4/theme/assets/pages/media/profile/people19.png'
              className='w-[3rem] md:w-[2.5rem]  border-2 border-black rounded-full pt-1 bg-white'
            />
      ...
      <div className='w-full h-full bg-green-300 md:w-[70%]'></div>
      <div className='md:hidden w-full bg-white absolute bottom-0 flex flex-col items-center justify-center py-1 transition-all duration-500' style={{ height: containerHeight }}>
        <h1 className='font-bold text-2xl my-3'>Confirm This Ride To Start</h1>
        <div className='w-[90%] h-[4rem] bg-yellow-400 flex items-center justify-around rounded-xl'>
          <img src='https://preview.keenthemes.com/metronic-v4/theme/assets/pages/media/profile/people19.png'
            className='w-[3rem]  border-2 border-black rounded-full pt-1 bg-white'
          />
          <h2 className='font-bold'>Ankan Mandal</h2>
          <h2 className='font-bold'>2.2Km</h2>
        </div>
